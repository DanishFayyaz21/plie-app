...
const ClaimModel = (props) => {
    ...
    const { visible, description1, accepted, cancel, title, height = 230, exitFunction = null } = props;
                    ...
                    <View style={[styles.sty3, { height: normalize(height) }]}>
                        ...
                        <ScrollView>
                            <View style={styles.sty25}>
                                ...
                                <Text style={styles.sty21}>{description1}</Text>
                                <Text style={styles.sty21}>{description1}</Text>


                            </View>

                                <PlieButton style={styles.styButtonReady} text="Confirm" onPress={() => onApply()} />
                        </ScrollView>
                    </View>
                </View>
            </View>
