...
function SelectLocationModal(props) {
  ...
  const { visible, selectedCountryList, selectedCityList,setCountry ,setCity,title="Event Details",isEdit=false,countrySelected,citySelected} = props
...
//   }, [danceStyleList])
  ...
  const onApply = () => {
    ...
    if(countryIds[0] && cityIds[0] )
    {
      console.log("Country SELECTED ",countryIds);
      console.log("City SELECTED ",cityIds);
      setCountry(countryIds[0]);
      setCity(cityIds[0]);
      onClose();
    }
  ...
  console.log("countryList",mCountryList);
  console.log("cityList",mCityList);
  return (
    <Modal
      visible={visible}
      transparent={true}
              ...
              <View style={styles.sty25}>
                ...
                <View style={styles.sty6}>
                  <View>
                    ...
                    { isEdit && mCountryList.length == 0 && (
                          <View>
                            <Text style={styles.sty26}>{countrySelected.cnt_name}</Text>
                          </View>
                      )
                  ...
                  <View>
                    ...
                    { isEdit && mCityList.length == 0 && (
                          <View>
                            <Text style={styles.sty26}>{citySelected.cty_name}</Text>
                          </View>
                      )
                    }
                    {mCityList.length > 0 &&
